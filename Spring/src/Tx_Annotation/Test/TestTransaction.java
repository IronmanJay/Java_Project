package Tx_Annotation.Test;

import Tx_Annotation.Dao.BookShopDao;
import Tx_Annotation.Service.BookShopService;
import Tx_Annotation.Service.Cashier;
...
public class TestTransaction {
    ...
    @Before
    public void init(){
        ApplicationContext ctx = new ClassPathXmlApplicationContext("spring-jdbc_book.xml");
