...
public class Exer2Test {
    ...
    public static void main(String[] args) {
          /*Exer2Test et1 = new Exer2Test();
          et1.testInsert1();
          Exer2Test et2 = new Exer2Test();
          et2.queryWithIDCardOrExamCard();
          Exer2Test et3 = new Exer2Test();
          et3.testDeleteByExamCard();*/
          Exer2Test et4 = new Exer2Test();
          et4.testDeleteByExamCard1();
    }
    ...
    public void testDeleteByExamCard1(){
        ...
        int deleteCount = update(sql2,examCard);
        if(deleteCount > 0){
            System.out.println("删除成功");
        }else{
            System.out.println("查无此人，请重新输入!");
